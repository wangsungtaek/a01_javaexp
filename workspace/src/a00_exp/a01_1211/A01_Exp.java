...
-> 기본형 타입은 스택영역에 할당되며, 객체는 힙영역에 할당된다.
	...
	stack : primitive데이터 유형할당, 객체의 heap영역 주소할당
	heap : 생성된 객체를 할당.
...
-> 비교 연산자 '=='을 사용하게 되면 객체의 주소를 비교하며,
	...
	String name1 ="홍길동"; "홍길동"으로된 모든 문자열은 heap영역에 같은 주소를 쓴다.
...
//		System.out.print("\t1: "+(int)((no1/(double)6)*100)+"%\t");
//		System.out.print("2: "+(int)((no2/(double)6)*100)+"%\t");
//		System.out.print("3: "+(int)((no3/(double)6)*100)+"%\t");
//		System.out.print("4: "+(int)((no4/(double)6)*100)+"%\t");
//		System.out.print("5: "+(int)((no5/(double)6)*100)+"%\t");
//		System.out.print("6: "+(int)((no6/(double)6)*100)+"%\t");
...
//		System.out.println();
		...
		System.out.print("가위:1, 바위:2, 보:3를 입력하세요:");
		int chIdx = sc.nextInt()-1;
		System.out.println("내가 낸 내용:"+games[chIdx]);
		int ranIdx = (int)(Math.random()*games.length); // 0,1,2 중에 임의로 출력..
		System.out.println("컴퓨터의 결과:"+games[ranIdx]);
		if(chIdx == ranIdx) {
			System.out.println("무승부");
		} else if((chIdx%3+1) == ranIdx) {
